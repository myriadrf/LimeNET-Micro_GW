...
entity gnsscfg is
   port (
      ...
      en                : out std_logic;  -- 0 - disable, 1 - enable. gnss module control
      
      gprmc_utc         : in std_logic_vector(35 downto 0); -- HH-MM-SS1.SSS0 
      gprmc_status      : in std_logic; --Status 1 = Data valid, 0 = Navigation receiver warning
      gprmc_lat         : in std_logic_vector(32 downto 0); -- n_s-LL3-LL2.LL1-LL0
      gprmc_long        : in std_logic_vector(36 downto 0); -- e_w-Y4-YY3-YY2.YY1-YY0
      gprmc_speed       : in std_logic_vector(23 downto 0); -- XX2-XX1.XX0
...
architecture arch of gnsscfg is
   ...
   signal mem: marray21x16;                           -- Config memory
...
gprmc_utc_sss0      <= gprmc_utc(11 downto 0);
gprmc_utc_ss1       <= gprmc_utc(19 downto 12);
gprmc_utc_mm        <= gprmc_utc(27 downto 20);
gprmc_utc_hh        <= gprmc_utc(35 downto 28);
--Latitude,  LL3-LL2.LL1-LL0
gprmc_lat_ll0       <= gprmc_lat(7 downto 0);
gprmc_lat_ll1       <= gprmc_lat(15 downto 8);
gprmc_lat_ll2       <= gprmc_lat(23 downto 16);
gprmc_lat_ll3       <= gprmc_lat(31 downto 24);
gprmc_lat_n_s       <= gprmc_lat(32); -- Latitude 0 – N, 1 – S

--Longitude, Y4-YY3-YY2.YY1-YY0
gprmc_long_yy0      <= gprmc_long(7 downto 0);
gprmc_long_yy1      <= gprmc_long(15 downto 8);
gprmc_long_yy2      <= gprmc_long(23 downto 16);
gprmc_long_yy3      <= gprmc_long(31 downto 24);
gprmc_long_y4       <= gprmc_long(35 downto 32);
gprmc_long_e_w      <= gprmc_long(36); -- Longitude, 0 – E, 1 – W

--Speed over ground, knots, XX2-XX1.XX0
gprmc_speed_xx0     <= gprmc_speed(7 downto 0);
gprmc_speed_xx1     <= gprmc_speed(15 downto 8);
gprmc_speed_xx2     <= gprmc_speed(23 downto 16);

--Course Over Ground, degrees True, X2-XX1.XX0 
gprmc_course_xx0    <= gprmc_course(7 downto 0);
gprmc_course_xx1    <= gprmc_course(15 downto 8);
gprmc_course_x2     <= gprmc_course(19 downto 16);

--Date: DD-MM-YY
gprmc_date_yy       <= gprmc_date(7 downto 0);
gprmc_date_mm       <= gprmc_date(15 downto 8);
gprmc_date_dd       <= gprmc_date(23 downto 16);
      ...
      if lreset = '0' then
         ...
         -- Load operation
            ...
            case inst_reg(4 downto 0) is -- mux read-only outputs
               ...
               -- inst_reg=4
               when "00100" => dout_reg <= x"00" & "0000000" & gprmc_status;              
               -- inst_reg=5
